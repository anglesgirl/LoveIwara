...
class _TranslationsCommonZhTw implements TranslationsCommonEn {
	...
	@override String get mobileSaveImageIsUnderDevelopment => '行動端的儲存圖片功能尚在開發中';
	...
	@override String get showProcessedText => '顯示處理後文字';
	...
	@override String get createPost => '建立投稿';
	...
	@override String get disableFloatingButtons => '停用浮動按鈕';
...
class _TranslationsErrorsZhTw implements TranslationsErrorsEn {
	...
	@override String get unknownError => '未知錯誤';
	@override String get sessionExpired => '工作階段已過期';
...
class _TranslationsFriendsZhTw implements TranslationsFriendsEn {
	...
	// Translations
	@override String get clickToRestoreFriend => '點擊復原朋友';
...
class _TranslationsPlayListZhTw implements TranslationsPlayListEn {
	...
	@override String get yesCreateListWillAlwaysExistAndVisibleToEveryone => '沒錯...建立的播放清單會一直存在且對所有人可見';
	...
	@override String get createNewPlaylist => '建立新播放清單';
...
class _TranslationsSearchZhTw implements TranslationsSearchEn {
	...
	@override String get googleSearch => 'Google搜尋';
	@override String googleSearchHint({required Object webName}) => '${webName} 的搜尋功能不好用？嘗試Google搜尋！';
	@override String get googleSearchDescription => '借助Google搜尋的 :site 搜尋運算符，您可以透過外部引擎來對站內的內容進行檢索，此功能在搜尋 影片、圖庫、播放清單、使用者 時非常有用。';
	@override String get googleSearchKeywordsHint => '輸入要搜尋的關鍵字';
	@override String get openLinkJump => '打開連結跳轉';
	@override String get googleSearchButton => 'Google搜尋';
...
class _TranslationsSettingsZhTw implements TranslationsSettingsEn {
	...
	@override String get invalidProxyAddressFormatPleaseUseTheFormatOfIpPortOrDomainNamePort => '無效的代理伺服器地址格式，請使用 IP:埠 或 域名:埠 格式。';
	...
	@override String get theaterModeDesc => '開啟後，播放器背景會被設定為影片封面的模糊版本';
	@override String get appLinks => '應用連結';
	...
	@override String get enableVibrationDesc => '啟用應用互動時的震動回饋';
	...
	@override String get videoSyncMode => '影片同步模式';
	@override String get videoSyncModeSubtitle => '影音同步策略';
	...
	@override String get useOpenSLESAudioOutput => '使用OpenSLES音訊輸出';
	@override String get useOpenSLESAudioOutputInfo => '使用低延遲音訊輸出，可能提高音頻效能';
	@override String get videoSyncAudio => '音訊同步';
	...
	@override String get videoSyncDisplayVdrop => '顯示丟影片幀';
	@override String get videoSyncDisplayAdrop => '顯示丟音訊幀';
	...
	@override String get hardwareDecodingNo => '停用';
...
class _TranslationsSubscriptionsZhTw implements TranslationsSubscriptionsEn {
	...
	@override String get selectUser => '選擇使用者';
	@override String get noSubscribedUsers => '尚無已訂閱使用者';
	@override String get showAllSubscribedUsersContent => '顯示所有已訂閱使用者的內容';
}
...
class _TranslationsVideoDetailZhTw implements TranslationsVideoDetailEn {
	...
	@override String get resourceDeleted => '這個影片好像被刪除了 :/';
	...
	@override String get videoLoadError => '影片載入錯誤';
...
class _TranslationsShareZhTw implements TranslationsShareEn {
	...
	@override String get wowDidYouSeeThis => '哇哦，你看過這個嗎？';
	...
	@override String get shareAsText => '分享為文字';
	@override String get shareAsImageDesc => '將影片封面分享為圖片';
	@override String get shareAsTextDesc => '將影片詳情分享為文字';
	@override String get shareAsImageFailed => '分享影片封面為圖片失敗，請稍後再試';
	@override String get shareAsTextFailed => '分享影片詳情為文字失敗，請稍後再試';
	...
	@override String get shareUser => '分享使用者';
	@override String get userNameIs => '使用者名稱字叫做';
	@override String get userAuthorIs => '使用者作者是';
...
class _TranslationsMarkdownZhTw implements TranslationsMarkdownEn {
	...
	@override String get internalLink => '站內連結';
	@override String get supportAutoConvertLinkBelow => '支援自動轉換以下類型的連結：';
	@override String get convertLinkExample => '🎬 影片連結\n🖼️ 圖片連結\n👤 使用者連結\n📌 論壇連結\n🎵 播放列錶連結\n💬 帖子連結';
	@override String get mentionUser => '提及使用者';
	@override String get mentionUserDescription => '輸入@後跟使用者名稱，將自動轉換為使用者連結';
	...
	@override String get textStyle => '文字樣式';
	@override String get textStyleDescription => '使用特殊符號包圍文本來改變樣式';
	@override String get textStyleSyntax => '**粗體文字**\n*斜體文字*\n~~刪除線文字~~\n`程式碼文字`';
	@override String get quote => '引用';
	@override String get quoteDescription => '使用 > 符號建立引用，多個 > 建立多級引用';
	@override String get quoteSyntax => '> 這是一級引用\n>> 這是二級引用';
	@override String get list => '列表';
	@override String get listDescription => '使用數字+點號建立有序列表，使用 - 建立無序列表';
	@override String get listSyntax => '1. 第一項\n2. 第二項\n\n- 無序項\n  - 子項\n  - 另一個子項';
	@override String get linkAndImage => '連結與圖片';
	@override String get linkAndImageDescription => '連結格式：[文字](URL)\n圖片格式：![描述](URL)';
	@override String linkAndImageSyntax({required Object link, required Object imgUrl}) => '[連結文字](${link})\n![圖片描述](${imgUrl})';
	@override String get title => '標題';
	@override String get titleDescription => '使用 # 號建立標題，數量表示級別';
	@override String get titleSyntax => '# 一級標題\n## 二級標題\n### 三級標題';
	@override String get separator => '分隔線';
	@override String get separatorDescription => '使用三個或更多 - 號建立分隔線';
...
class _TranslationsForumZhTw implements TranslationsForumEn {
	...
	@override String get forum => '論壇';
	@override String get createThread => '建立主題';
...
class _TranslationsNotificationsZhTw implements TranslationsNotificationsEn {
	...
	@override String get copyInfoToClipboard => '複製通知資訊到剪貼簿';
	@override String get copySuccess => '已複製到剪貼簿';
	@override String copySuccessForMessage({required Object str}) => '已複製到剪貼簿: ${str}';
	...
	@override String get dueToLackOfNotificationTypeDetails => '通知類型的詳細資訊不足，目前支援的類型可能沒有覆蓋到您目前收到的消息';
	@override String get helpUsImproveNotificationTypeSupport => '如果您願意幫助我們完善通知類型的支援：';
	@override String get helpUsImproveNotificationTypeSupportLongText => '1. 📋 複製通知資訊\n2. 🐞 前往項目倉庫提交 issue\n\n⚠️ 注意：通知資訊可能包含個人隱私，如果你不想公開，也可以透過郵件發送給項目作者。';
	@override String get goToRepository => '前往項目倉庫';
	@override String get copy => '複製';
	@override String get commentApproved => '評論已透過';
	@override String get repliedYourProfileComment => '回覆了您的個人首頁評論';
	...
	@override String get kProfile => '首頁';
	@override String get kThread => '主題';
	@override String get kPost => '投稿';
	@override String get kCommentSection => '下的評論';
	@override String get kApprovedComment => '評論已透過';
	@override String get kApprovedVideo => '影片已透過';
	@override String get kApprovedGallery => '圖庫已透過';
	@override String get kApprovedThread => '主題已審核';
	@override String get kApprovedPost => '投稿已審核';
	@override String get kApprovedForumPost => '論壇發言審核透過';
...
class _TranslationsConversationZhTw implements TranslationsConversationEn {
	...
	@override String get conversation => '工作階段';
	@override String get startConversation => '發起工作階段';
	@override String get noConversation => '暫無工作階段';
	@override String get selectFromLeftListAndStartConversation => '從左側列表選擇一個工作階段開始聊天';
	@override String get title => '標題';
	@override String get body => '內容';
	@override String get selectAUser => '選擇使用者';
	@override String get searchUsers => '搜尋使用者...';
	@override String get tmpNoConversions => '暫無工作階段';
...
class _TranslationsDownloadZhTw implements TranslationsDownloadEn {
	...
	@override String get showInFolder => '在資料夾中顯示';
...
class _TranslationsFavoriteZhTw implements TranslationsFavoriteEn {
	...
	@override String get createFolderSuccess => '資料夾建立成功';
	@override String get createFolderFailed => '建立資料夾失敗';
	@override String get createFolder => '建立資料夾';
	@override String get enterFolderName => '輸入資料夾名稱';
	@override String get enterFolderNameHere => '在此輸入資料夾名稱...';
	@override String get create => '建立';
	@override String get items => '項目';
	@override String get newFolderName => '新資料夾';
	@override String get searchFolders => '搜尋資料夾...';
	@override String get searchItems => '搜尋項目...';
	@override String get createdAt => '建立時間';
	@override String get myFavorites => '我的收藏';
	@override String get deleteFolderTitle => '刪除資料夾';
	@override String deleteFolderConfirmWithTitle({required Object title}) => '確定要刪除 ${title} 資料夾嗎？';
	...
	@override String get localizeFavorite => '本機收藏';
...
class _TranslationsTranslationZhTw implements TranslationsTranslationEn {
	...
	@override String get testConnectionSuccess => '測試連線成功';
	@override String get testConnectionFailed => '測試連線失敗';
	@override String testConnectionFailedWithMessage({required Object message}) => '測試連線失敗: ${message}';
	@override String get translation => '翻譯';
	@override String get needVerification => '需要驗證';
	@override String get needVerificationContent => '請先透過連接測試才能啟用AI翻譯';
	@override String get confirm => '確定';
	@override String get disclaimer => '使用須知';
	@override String get riskWarning => '風險提示';
	@override String get dureToRisk1 => '由於評論等文字為使用者生成，可能包含違反AI服務商內容政策的內容';
	@override String get dureToRisk2 => '不當內容可能導致API金鑰封禁或服務終止';
	...
	@override String get pleaseFillInAPIAddressModelNameAndKey => '請填寫API地址、模型名稱和金鑰';
	...
	@override String get configuredKey => '已配置金鑰';
	@override String get notConfiguredKey => '未配置金鑰';
	@override String get authenticationStatus => '認證狀態';
	@override String get thisFieldCannotBeEmpty => '此欄位不能為空';
	@override String get apiKey => 'API金鑰';
	@override String get apiKeyCannotBeEmpty => 'API金鑰不能為空';
	...
	@override String connectionFailedForMessage({required Object message}) => '連線失敗: ${message}';
	@override String get aiTranslationNotEnabledHint => 'AI翻譯未啟用，請在設定中啟用';
	@override String get goToSettings => '前往設定';
	@override String get disableAITranslation => '停用AI翻譯';
	...
	@override String get onlyOpenAIAPISupported => '目前僅支援OpenAI相容的API格式（application/json請求體格式）';
	@override String get streamingTranslation => '流式翻譯';
	@override String get streamingTranslationSupported => '支援流式翻譯';
	@override String get streamingTranslationNotSupported => '不支援流式翻譯';
	@override String get streamingTranslationDescription => '流式翻譯可以在翻譯過程中即時顯示結果，提供更好的使用者體驗';
	...
	@override String get streamingTranslationWarning => '注意：此功能需要API服務支援流式傳輸，部分模型可能不支援';
	...
	@override String get dlSessionHelperText => 'Pro 端點必需的工作階段參數，從 DeepL Pro 帳戶獲取';
	...
	@override String get deepLXTranslationWillBeDisabled => 'DeepLX翻譯將因配置更改而被停用';
	...
	@override String get streamingTranslationDataTimeout => '流式翻譯接收資料超時';
	@override String get dataReceptionTimeout => '接收資料超時';
	@override String get streamDataParseError => '解析流資料時出錯';
...
class _TranslationsLinkInputDialogZhTw implements TranslationsLinkInputDialogEn {
	...
	@override String supportedLinksHint({required Object webName}) => '支援智慧識別多個${webName}連結，並快速跳轉到應用內對應頁面(連結與其他文字之間用空格隔開)';
	...
	@override String get unsupportedLinkDialogContent => '該連結類型目前應用無法直接打開，需要使用外部瀏覽器訪問。\n\n是否使用瀏覽器打開此連結？';
...
class _TranslationsLogZhTw implements TranslationsLogEn {
	...
	// Translations
	@override String get logManagement => '日誌管理';
	@override String get enableLogPersistence => '持久化日誌';
	@override String get enableLogPersistenceDesc => '將日誌儲存到資料庫以便於分析問題';
	@override String get logDatabaseSizeLimit => '日誌資料庫大小上限';
	@override String logDatabaseSizeLimitDesc({required Object size}) => '目前: ${size}';
	@override String get exportCurrentLogs => '匯出目前日誌';
	@override String get exportCurrentLogsDesc => '匯出當天應用日誌以幫助開發者診斷問題';
	@override String get exportHistoryLogs => '匯出歷史日誌';
	@override String get exportHistoryLogsDesc => '匯出指定日期範圍內的日誌';
	@override String get exportMergedLogs => '匯出合併日誌';
	@override String get exportMergedLogsDesc => '匯出指定日期範圍內的合併日誌';
	@override String get showLogStats => '顯示日誌統計資訊';
	@override String get logExportSuccess => '日誌匯出成功';
	@override String logExportFailed({required Object error}) => '日誌匯出失敗: ${error}';
	@override String get showLogStatsDesc => '查看各種類型日誌的統計資料';
	@override String logExtractFailed({required Object error}) => '獲取日誌統計失敗: ${error}';
	@override String get clearAllLogs => '清理所有日誌';
	@override String get clearAllLogsDesc => '清理所有日誌資料';
	@override String get confirmClearAllLogs => '確認清理';
	@override String get confirmClearAllLogsDesc => '確定要清理所有日誌資料嗎？此操作不可復原。';
	@override String get clearAllLogsSuccess => '日誌清理成功';
	@override String clearAllLogsFailed({required Object error}) => '清理日誌失敗: ${error}';
	@override String get unableToGetLogSizeInfo => '無法獲取日誌大小資訊';
	@override String get currentLogSize => '目前日誌大小:';
	@override String get logCount => '日誌數量:';
	...
	@override String get currentLogSizeExceededPleaseCleanOldLogsOrIncreaseLogSizeLimit => '日誌空間已超出限制，建議立即清理舊日誌或增加空間限制';
	@override String get currentLogSizeAlmostExceededPleaseCleanOldLogs => '日誌空間即將用盡，建議清理舊日誌';
	@override String get cleaningOldLogs => '正在自動清理舊日誌...';
	@override String get logCleaningCompleted => '日誌清理完成';
	@override String get logCleaningProcessMayNotBeCompleted => '日誌清理過程可能未完成';
	@override String get cleanExceededLogs => '清理超出限制的日誌';
	@override String get noLogsToExport => '沒有可匯出的日誌資料';
	@override String get exportingLogs => '正在匯出日誌...';
	@override String get noHistoryLogsToExport => '尚無可匯出的歷史日誌，請先使用應用一段時間再嘗試';
	@override String get selectLogDate => '選擇日誌日期';
	@override String get today => '今天';
	@override String get selectMergeRange => '選擇合併範圍';
	@override String get selectMergeRangeHint => '請選擇要合併的日誌時間範圍';
	@override String selectMergeRangeDays({required Object days}) => '最近 ${days} 天';
	@override String get logStats => '日誌統計資訊';
	@override String todayLogs({required Object count}) => '今日日誌: ${count} 條';
	@override String recent7DaysLogs({required Object count}) => '最近7天: ${count} 條';
	@override String totalLogs({required Object count}) => '總計日誌: ${count} 條';
	@override String get setLogDatabaseSizeLimit => '設定日誌資料庫大小上限';
	@override String currentLogSizeWithSize({required Object size}) => '目前日誌大小: ${size}';
	...
	@override String logSizeLimitSetSuccess({required Object size}) => '日誌大小上限已設定為 ${size}';
}
...
class _TranslationsEmojiZhTw implements TranslationsEmojiEn {
	...
	@override String get cancel => '取消';
	@override String get batchDelete => '批次刪除';
	@override String confirmBatchDelete({required Object count}) => '確定要刪除選中的${count}張圖片嗎？此操作不可復原。';
	@override String get deleteSuccess => '成功刪除';
	@override String get addImage => '添加圖片';
	@override String get addImageByUrl => '透過URL添加';
	@override String get addImageUrl => '添加圖片URL';
	@override String get imageUrl => '圖片URL';
	@override String get enterImageUrl => '請輸入圖片URL';
	@override String get add => '添加';
	@override String get batchImport => '批次匯入';
	@override String get enterJsonUrlArray => '請輸入JSON格式的URL陣列:';
	@override String get formatExample => '格式範例:\n["url1", "url2", "url3"]';
	@override String get pasteJsonUrlArray => '請貼上JSON格式的URL陣列';
	@override String get import => '匯入';
	@override String importSuccess({required Object count}) => '成功匯入${count}張圖片';
	@override String get jsonFormatError => 'JSON格式錯誤，請檢查輸入';
	@override String get createGroup => '建立表情包分組';
...
class _TranslationsNavigationOrderSettingsZhTw implements TranslationsNavigationOrderSettingsEn {
	...
	@override String get customNavigationOrder => '自訂導航順序';
	@override String get customNavigationOrderDesc => '拖曳調整底部導航欄和側邊欄中各個頁面的顯示順序';
...
class _TranslationsAnime4kZhTw implements TranslationsAnime4kEn {
	...
	// Translations
	@override String get realTimeVideoUpscalingAndDenoising => 'Anime4K 即時影片上採樣和降噪，提升動畫影片品質';
	@override String get settings => 'Anime4K 設定';
	@override String get preset => 'Anime4K 預設';
	@override String get disable => '關閉 Anime4K';
	@override String get disableDescription => '停用影片增強效果';
	...
	@override String get customPresets => '自訂預設';
...
class _TranslationsSiteModeZhTw implements TranslationsSiteModeEn {
	...
	@override String get chooseLinkTargetTitle => '選擇連結目標站點';
	@override String get chooseLinkTargetDescription => '此連結未包含網域，請選擇要前往主站還是 AI 站。';
	@override String get chooseLinkTargetHint => '進入後，此頁面及其後續詳情請求會沿用你選擇的站點。';
...
class _TranslationsSettingsDownloadSettingsZhTw implements TranslationsSettingsDownloadSettingsEn {
	...
	@override String get storagePermissionGranted => '已授權儲存權限';
	...
	@override String get androidWarning => 'Android提示：避免選擇公共目錄（如下載資料夾），建議使用應用程式專用目錄以確儲存取權限。';
	...
	@override String get enableCustomDownloadPath => '啟用自訂下載路徑';
	@override String get disableCustomDownloadPath => '關閉時使用應用程式預設路徑';
	@override String get customDownloadPathLabel => '自訂下載路徑';
	...
	@override String get filenameTemplateDescription => '自訂下載檔案的命名規則，支援變數取代';
	...
	@override String get testStoragePermissionGranted => '已獲得儲存權限';
	@override String get testStoragePermissionMissing => '缺少儲存權限，部分功能可能受限';
	...
	@override String get testVideoTemplate => '影片模板';
	...
	@override String get testDirectoryCreation => '目錄建立';
	...
	@override String get lackStoragePermission => '缺少儲存權限';
	...
	@override String get requiresStoragePermission => '需要儲存權限才能存取';
...
class _TranslationsOreno3dErrorsZhTw implements TranslationsOreno3dErrorsEn {
	...
	@override String get connectionError => '網路連接錯誤，請檢查網路設定';
	@override String get networkRequestFailed => '網路請求失敗';
	@override String get searchVideoError => '搜尋影片時發生未知錯誤';
	@override String get getPopularVideoError => '獲取熱門影片時發生未知錯誤';
	@override String get getVideoDetailError => '獲取影片詳情時發生未知錯誤';
	@override String get parseVideoDetailError => '獲取並解析影片詳情時發生未知錯誤';
...
class _TranslationsOreno3dLoadingZhTw implements TranslationsOreno3dLoadingEn {
	...
	// Translations
	@override String get gettingVideoInfo => '正在獲取影片資訊...';
	@override String get cancel => '取消';
}
...
class _TranslationsOreno3dMessagesZhTw implements TranslationsOreno3dMessagesEn {
	...
	// Translations
	@override String get videoNotFoundOrDeleted => '影片不存在或已被刪除';
	@override String get unableToGetVideoPlayLink => '無法獲取影片播放連結';
	@override String get getVideoDetailFailed => '獲取影片詳情失敗';
}
...
class _TranslationsVideoDetailSkeletonZhTw implements TranslationsVideoDetailSkeletonEn {
	...
	@override String get successFecthVideoDurationInfo => '成功獲取影片資源，開始載入影片...';
	@override String get successFecthVideoHeightInfo => '載入完成';
}
...
class _TranslationsVideoDetailCastZhTw implements TranslationsVideoDetailCastEn {
	...
	// Translations
	@override String get dlnaCast => '投影';
	@override String unableToStartCastingSearch({required Object error}) => '啟動投影搜尋失敗: ${error}';
	@override String startCastingTo({required Object deviceName}) => '開始投影到 ${deviceName}';
	@override String castFailed({required Object error}) => '投影失敗: ${error}\n請嘗試重新搜尋裝置或切換網路';
	@override String get castStopped => '已停止投影';
	...
	@override String get currentPlatformNotSupported => '目前平台不支援投影功能';
	@override String get unableToGetVideoUrl => '無法獲取影片網址，請稍後重試';
	@override String get stopCasting => '停止投影';
...
class _TranslationsForumLeafDescriptionsZhTw implements TranslationsForumLeafDescriptionsEn {
	...
	@override String get feedback => '對網站功能和服務的回饋';
	@override String get support => '幫助解決網站相關問題';
	@override String get general => '討論任何話題';
	@override String get guides => '分享你的經驗和教學';
...
class _TranslationsNotificationsErrorsZhTw implements TranslationsNotificationsErrorsEn {
	...
	// Translations
	@override String get unsupportedNotificationType => '暫不支援的通知類型';
	@override String get unknownUser => '未知使用者';
	@override String unsupportedNotificationTypeWithType({required Object type}) => '暫不支援的通知類型: ${type}';
...
class _TranslationsConversationErrorsZhTw implements TranslationsConversationErrorsEn {
	...
	// Translations
	@override String get pleaseSelectAUser => '請選擇一個使用者';
	@override String get pleaseEnterATitle => '請輸入標題';
	@override String get clickToSelectAUser => '點擊選擇使用者';
	@override String get loadFailedClickToRetry => '載入失敗,點擊重試';
...
class _TranslationsDownloadErrorsZhTw implements TranslationsDownloadErrorsEn {
	...
	// Translations
	@override String get imageModelNotFound => '圖庫資訊不存在';
	...
	@override String get openFolderFailed => '打開資料夾失敗';
	@override String openFolderFailedWithMessage({required Object message}) => '打開資料夾失敗: ${message}';
	...
	@override String unsupportedImageFormat({required Object format}) => '不支援的圖片格式: ${format}';
	@override String get deleteFileError => '文件刪除失敗，可能是因為文件被占用';
...
class _TranslationsDownloadBatchDownloadZhTw implements TranslationsDownloadBatchDownloadEn {
	_TranslationsDownloadBatchDownloadZhTw._(this._root);

	final TranslationsZhTw _root; // ignore: unused_field

	// Translations
	@override String get title => '批量下載';
	@override String get downloadTaskAlreadyRunning => '任務正在運行中，請稍候';
	@override String get userCancelled => '用戶取消';
	@override String get failedToGetVideoInfo => '無法獲取影片資訊';
	@override String get failedToGetVideoSource => '無法獲取影片源';
	@override String get failedToGetGalleryInfo => '無法獲取圖庫資訊';
	@override String get galleryNoImages => '圖庫中沒有圖片';
	@override String get failedToGetSavePath => '無法獲取保存路徑';
	@override String batchDownloadFailedWithException({required Object exception}) => '批量下載失敗: ${exception}';
	@override String get selectQuality => '選擇清晰度';
	@override String get downloading => '下載中';
	@override String get downloadResult => '下載結果';
	@override String selectedVideosCount({required Object count}) => '已選擇 ${count} 個影片';
	...
	@override String get failed => '失敗';
	@override String get failureDetails => '失敗詳情';
	@override String get reasonPrivateVideo => '私人影片';
	@override String get reasonAlreadyExists => '任務已存在';
	@override String get reasonNoSource => '無下載源';
	@override String get reasonNoSavePath => '無法取得儲存路徑';
	@override String get reasonOther => '其他錯誤';
	@override String get startDownload => '開始下載';
}
...
class _TranslationsAnime4kPresetDescriptionsZhTw implements TranslationsAnime4kPresetDescriptionsEn {
	...
	@override String get mode_c_hq => '適用於幾乎沒有瑕疵的高品質片源（如原生1080p的動畫電影或桌布）。降噪並提供最高的PSNR。';
	@override String get mode_a_a_hq => 'Mode A的強化版，提供極致的感知品質，能重建幾乎所有退化的線條。可能產生過度銳化或振鈴。';
	@override String get mode_b_b_hq => 'Mode B的強化版，提供更高的感知品質，進一步最佳化線條和減少瑕疵。';
	...
	@override String get mode_a_a_fast => 'Mode A+A的快速版本，在性能有限的裝置上追求更高的感知品質。';
	@override String get mode_b_b_fast => 'Mode B+B的快速版本，為性能有限的裝置提供增強的線條修復和瑕疵處理。';
	...
	@override String get upscale_deblur_fast => '使用快速的非CNN演算法進行放大和去模糊，效果優於傳統演算法，性能開銷很低。';
	@override String get restore_s_only => '僅使用最快的CNN模型修復畫面瑕疵，不進行放大。適用於原生解析度播放，但希望改善畫質的情況。';
	@override String get denoise_bilateral_fast => '使用傳統的雙邊濾波器進行降噪，速度極快，適用於處理輕微噪點。';
	@override String get upscale_non_cnn => '使用快速的傳統演算法進行放大，性能開銷極低，效果優於播放器內建演算法。';
...
class _TranslationsVideoDetailCastDeviceTypesZhTw implements TranslationsVideoDetailCastDeviceTypesEn {
	...
	@override String get basicDevice => '基礎裝置';
	@override String get dimmableLight => '智慧燈';
	@override String get wlanAccessPoint => '無線接入點';
	@override String get wlanConnectionDevice => '無線連接裝置';
	@override String get printer => '印表機';
	@override String get scanner => '掃描器';
	@override String get digitalSecurityCamera => '攝影機';
...
class _TranslationsVideoDetailCastDlnaCastSheetZhTw implements TranslationsVideoDetailCastDlnaCastSheetEn {
	...
	// Translations
	@override String get title => '遠端投影';
	@override String get close => '關閉';
	@override String get searchingDevices => '正在搜尋裝置...';
	@override String get searchPrompt => '點擊搜尋按鈕重新搜尋投影裝置';
	@override String get searching => '搜尋中';
	@override String get searchAgain => '重新搜尋';
	@override String get noDevicesFound => '未發現投影裝置\n請確保裝置在同一網路下';
	@override String get searchingDevicesPrompt => '正在搜尋裝置，請稍候...';
	@override String get cast => '投影';
	@override String connectedTo({required Object deviceName}) => '已連接到: ${deviceName}';
	@override String get notConnected => '未連接裝置';
	@override String get stopCasting => '停止投影';
}
...
extension on TranslationsZhTw {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'common.mobileSaveImageIsUnderDevelopment' => '行動端的儲存圖片功能尚在開發中',
			...
			'common.showProcessedText' => '顯示處理後文字',
			'common.preview' => '預覽',
			'common.rules' => '規則',
			'common.agree' => '同意',
			'common.disagree' => '不同意',
			...
			'common.disableFloatingButtons' => '停用浮動按鈕',
			...
			'playList.yesCreateListWillAlwaysExistAndVisibleToEveryone' => '沒錯...建立的播放清單會一直存在且對所有人可見',
			...
			'playList.createNewPlaylist' => '建立新播放清單',
			'playList.videos' => '影片',
			...
			'search.googleSearch' => 'Google搜尋',
			'search.googleSearchHint' => ({required Object webName}) => '${webName} 的搜尋功能不好用？嘗試Google搜尋！',
			'search.googleSearchDescription' => '借助Google搜尋的 :site 搜尋運算符，您可以透過外部引擎來對站內的內容進行檢索，此功能在搜尋 影片、圖庫、播放清單、使用者 時非常有用。',
			'search.googleSearchKeywordsHint' => '輸入要搜尋的關鍵字',
			'search.openLinkJump' => '打開連結跳轉',
			'search.googleSearchButton' => 'Google搜尋',
			...
			'settings.theaterModeDesc' => '開啟後，播放器背景會被設定為影片封面的模糊版本',
			'settings.appLinks' => '應用連結',
			...
			'settings.videoSyncMode' => '影片同步模式',
			'settings.videoSyncModeSubtitle' => '影音同步策略',
			...
			'settings.videoSyncDisplayVdrop' => '顯示丟影片幀',
			'settings.videoSyncDisplayAdrop' => '顯示丟音訊幀',
			...
			'settings.hardwareDecodingNo' => '停用',
			...
			'settings.downloadSettings.storagePermissionGranted' => '已授權儲存權限',
			...
			'settings.downloadSettings.androidWarning' => 'Android提示：避免選擇公共目錄（如下載資料夾），建議使用應用程式專用目錄以確儲存取權限。',
			...
			'settings.downloadSettings.enableCustomDownloadPath' => '啟用自訂下載路徑',
			'settings.downloadSettings.disableCustomDownloadPath' => '關閉時使用應用程式預設路徑',
			'settings.downloadSettings.customDownloadPathLabel' => '自訂下載路徑',
			...
			'settings.downloadSettings.filenameTemplateDescription' => '自訂下載檔案的命名規則，支援變數取代',
			...
			'settings.downloadSettings.testStoragePermissionGranted' => '已獲得儲存權限',
			'settings.downloadSettings.testStoragePermissionMissing' => '缺少儲存權限，部分功能可能受限',
			...
			'settings.downloadSettings.testVideoTemplate' => '影片模板',
			...
			'settings.downloadSettings.requiresStoragePermission' => '需要儲存權限才能存取',
			...
			'oreno3d.errors.getPopularVideoError' => '獲取熱門影片時發生未知錯誤',
			'oreno3d.errors.getVideoDetailError' => '獲取影片詳情時發生未知錯誤',
			'oreno3d.errors.parseVideoDetailError' => '獲取並解析影片詳情時發生未知錯誤',
			...
			'subscriptions.selectUser' => '選擇使用者',
			'subscriptions.noSubscribedUsers' => '尚無已訂閱使用者',
			...
			'videoDetail.skeleton.successFecthVideoDurationInfo' => '成功獲取影片資源，開始載入影片...',
			'videoDetail.skeleton.successFecthVideoHeightInfo' => '載入完成',
			'videoDetail.cast.dlnaCast' => '投影',
			'videoDetail.cast.unableToStartCastingSearch' => ({required Object error}) => '啟動投影搜尋失敗: ${error}',
			'videoDetail.cast.startCastingTo' => ({required Object deviceName}) => '開始投影到 ${deviceName}',
			'videoDetail.cast.castFailed' => ({required Object error}) => '投影失敗: ${error}\n請嘗試重新搜尋裝置或切換網路',
			...
			'videoDetail.cast.deviceTypes.wlanConnectionDevice' => '無線連接裝置',
			'videoDetail.cast.deviceTypes.printer' => '印表機',
			'videoDetail.cast.deviceTypes.scanner' => '掃描器',
			'videoDetail.cast.deviceTypes.digitalSecurityCamera' => '攝影機',
			'videoDetail.cast.deviceTypes.unknownDevice' => '未知裝置',
			'videoDetail.cast.currentPlatformNotSupported' => '目前平台不支援投影功能',
			'videoDetail.cast.unableToGetVideoUrl' => '無法獲取影片網址，請稍後重試',
			'videoDetail.cast.stopCasting' => '停止投影',
			'videoDetail.cast.dlnaCastSheet.title' => '遠端投影',
			'videoDetail.cast.dlnaCastSheet.close' => '關閉',
			'videoDetail.cast.dlnaCastSheet.searchingDevices' => '正在搜尋裝置...',
			'videoDetail.cast.dlnaCastSheet.searchPrompt' => '點擊搜尋按鈕重新搜尋投影裝置',
			'videoDetail.cast.dlnaCastSheet.searching' => '搜尋中',
			'videoDetail.cast.dlnaCastSheet.searchAgain' => '重新搜尋',
			'videoDetail.cast.dlnaCastSheet.noDevicesFound' => '未發現投影裝置\n請確保裝置在同一網路下',
			'videoDetail.cast.dlnaCastSheet.searchingDevicesPrompt' => '正在搜尋裝置，請稍候...',
			'videoDetail.cast.dlnaCastSheet.cast' => '投影',
			'videoDetail.cast.dlnaCastSheet.connectedTo' => ({required Object deviceName}) => '已連接到: ${deviceName}',
			'videoDetail.cast.dlnaCastSheet.notConnected' => '未連接裝置',
			'videoDetail.cast.dlnaCastSheet.stopCasting' => '停止投影',
			...
			'share.wowDidYouSeeThis' => '哇哦，你看過這個嗎？',
			'share.nameIs' => '名字叫做',
			...
			'share.shareAsText' => '分享為文字',
			'share.shareAsImageDesc' => '將影片封面分享為圖片',
			'share.shareAsTextDesc' => '將影片詳情分享為文字',
			...
			'share.userNameIs' => '使用者名稱字叫做',
			'share.userAuthorIs' => '使用者作者是',
			'share.comments' => '評論',
			...
			'markdown.supportAutoConvertLinkBelow' => '支援自動轉換以下類型的連結：',
			'markdown.convertLinkExample' => '🎬 影片連結\n🖼️ 圖片連結\n👤 使用者連結\n📌 論壇連結\n🎵 播放列錶連結\n💬 帖子連結',
			...
			'forum.submit' => '提交',
			'notifications.errors.unsupportedNotificationType' => '暫不支援的通知類型',
			'notifications.errors.unknownUser' => '未知使用者',
			'notifications.errors.unsupportedNotificationTypeWithType' => ({required Object type}) => '暫不支援的通知類型: ${type}',
			...
			'notifications.dueToLackOfNotificationTypeDetails' => '通知類型的詳細資訊不足，目前支援的類型可能沒有覆蓋到您目前收到的消息',
			'notifications.helpUsImproveNotificationTypeSupport' => '如果您願意幫助我們完善通知類型的支援：',
			'notifications.helpUsImproveNotificationTypeSupportLongText' => '1. 📋 複製通知資訊\n2. 🐞 前往項目倉庫提交 issue\n\n⚠️ 注意：通知資訊可能包含個人隱私，如果你不想公開，也可以透過郵件發送給項目作者。',
			'notifications.goToRepository' => '前往項目倉庫',
			'notifications.copy' => '複製',
			'notifications.commentApproved' => '評論已透過',
			'notifications.repliedYourProfileComment' => '回覆了您的個人首頁評論',
			'notifications.kReplied' => '回覆了您在',
			'notifications.kCommented' => '評論了您的',
			'notifications.kVideo' => '影片',
			'notifications.kGallery' => '圖庫',
			'notifications.kProfile' => '首頁',
			'notifications.kThread' => '主題',
			'notifications.kPost' => '投稿',
			'notifications.kCommentSection' => '下的評論',
			'notifications.kApprovedComment' => '評論已透過',
			'notifications.kApprovedVideo' => '影片已透過',
			'notifications.kApprovedGallery' => '圖庫已透過',
			'notifications.kApprovedThread' => '主題已審核',
			'notifications.kApprovedPost' => '投稿已審核',
			'notifications.kApprovedForumPost' => '論壇發言審核透過',
			'notifications.kRejectedContent' => '內容審核被拒絕',
			'notifications.kUnknownType' => '未知通知類型',
			'conversation.errors.pleaseSelectAUser' => '請選擇一個使用者',
			'conversation.errors.pleaseEnterATitle' => '請輸入標題',
			'conversation.errors.clickToSelectAUser' => '點擊選擇使用者',
			'conversation.errors.loadFailedClickToRetry' => '載入失敗,點擊重試',
			'conversation.errors.loadFailed' => '載入失敗',
			'conversation.errors.clickToRetry' => '點擊重試',
			'conversation.errors.noMoreConversations' => '沒有更多消息了',
			'conversation.conversation' => '工作階段',
			'conversation.startConversation' => '發起工作階段',
			'conversation.noConversation' => '暫無工作階段',
			'conversation.selectFromLeftListAndStartConversation' => '從左側列表選擇一個工作階段開始聊天',
			'conversation.title' => '標題',
			'conversation.body' => '內容',
			'conversation.selectAUser' => '選擇使用者',
			'conversation.searchUsers' => '搜尋使用者...',
			'conversation.tmpNoConversions' => '暫無工作階段',
			...
			'download.errors.imageModelNotFound' => '圖庫資訊不存在',
			...
			'download.errors.imageLoadFailed' => '圖片載入失敗',
			...
			'download.batchDownload.failedToGetGalleryInfo' => '無法獲取圖庫資訊',
			'download.batchDownload.galleryNoImages' => '圖庫中沒有圖片',
			'download.batchDownload.failedToGetSavePath' => '無法獲取保存路徑',
			...
			'favorite.createFolderSuccess' => '資料夾建立成功',
			'favorite.createFolderFailed' => '建立資料夾失敗',
			...
			'favorite.searchFolders' => '搜尋資料夾...',
			'favorite.searchItems' => '搜尋項目...',
			'favorite.createdAt' => '建立時間',
			...
			'favorite.localizeFavorite' => '本機收藏',
			...
			'translation.testConnectionFailed' => '測試連線失敗',
			'translation.testConnectionFailedWithMessage' => ({required Object message}) => '測試連線失敗: ${message}',
			'translation.translation' => '翻譯',
			'translation.needVerification' => '需要驗證',
			'translation.needVerificationContent' => '請先透過連接測試才能啟用AI翻譯',
			'translation.confirm' => '確定',
			'translation.disclaimer' => '使用須知',
			'translation.riskWarning' => '風險提示',
			'translation.dureToRisk1' => '由於評論等文字為使用者生成，可能包含違反AI服務商內容政策的內容',
			'translation.dureToRisk2' => '不當內容可能導致API金鑰封禁或服務終止',
			...
			'translation.pleaseFillInAPIAddressModelNameAndKey' => '請填寫API地址、模型名稱和金鑰',
			...
			'translation.configuredKey' => '已配置金鑰',
			'translation.notConfiguredKey' => '未配置金鑰',
			'translation.authenticationStatus' => '認證狀態',
			'translation.thisFieldCannotBeEmpty' => '此欄位不能為空',
			'translation.apiKey' => 'API金鑰',
			'translation.apiKeyCannotBeEmpty' => 'API金鑰不能為空',
			...
			'translation.streamingTranslationWarning' => '注意：此功能需要API服務支援流式傳輸，部分模型可能不支援',
			...
			'translation.dlSessionHelperText' => 'Pro 端點必需的工作階段參數，從 DeepL Pro 帳戶獲取',
			...
			'translation.deepLXTranslationWillBeDisabled' => 'DeepLX翻譯將因配置更改而被停用',
			...
			'translation.connectionFailed' => '連線失敗',
			...
			'translation.streamingTranslationDataTimeout' => '流式翻譯接收資料超時',
			'translation.dataReceptionTimeout' => '接收資料超時',
			'translation.streamDataParseError' => '解析流資料時出錯',
			...
			'log.logManagement' => '日誌管理',
			'log.enableLogPersistence' => '持久化日誌',
			'log.enableLogPersistenceDesc' => '將日誌儲存到資料庫以便於分析問題',
			'log.logDatabaseSizeLimit' => '日誌資料庫大小上限',
			'log.logDatabaseSizeLimitDesc' => ({required Object size}) => '目前: ${size}',
			'log.exportCurrentLogs' => '匯出目前日誌',
			'log.exportCurrentLogsDesc' => '匯出當天應用日誌以幫助開發者診斷問題',
			'log.exportHistoryLogs' => '匯出歷史日誌',
			'log.exportHistoryLogsDesc' => '匯出指定日期範圍內的日誌',
			...
			'log.logExtractFailed' => ({required Object error}) => '獲取日誌統計失敗: ${error}',
			'log.clearAllLogs' => '清理所有日誌',
			'log.clearAllLogsDesc' => '清理所有日誌資料',
			'log.confirmClearAllLogs' => '確認清理',
			'log.confirmClearAllLogsDesc' => '確定要清理所有日誌資料嗎？此操作不可復原。',
			'log.clearAllLogsSuccess' => '日誌清理成功',
			'log.clearAllLogsFailed' => ({required Object error}) => '清理日誌失敗: ${error}',
			'log.unableToGetLogSizeInfo' => '無法獲取日誌大小資訊',
			'log.currentLogSize' => '目前日誌大小:',
			'log.logCount' => '日誌數量:',
			'log.logCountUnit' => '條',
			...
			'log.noHistoryLogsToExport' => '尚無可匯出的歷史日誌，請先使用應用一段時間再嘗試',
			'log.selectLogDate' => '選擇日誌日期',
			'log.today' => '今天',
			...
			'log.setLogDatabaseSizeLimit' => '設定日誌資料庫大小上限',
			'log.currentLogSizeWithSize' => ({required Object size}) => '目前日誌大小: ${size}',
			'log.warning' => '警告',
			...
			'anime4k.presetGroups.custom' => '自訂',
			...
			'anime4k.presetDescriptions.mode_c_hq' => '適用於幾乎沒有瑕疵的高品質片源（如原生1080p的動畫電影或桌布）。降噪並提供最高的PSNR。',
			...
			'anime4k.presetDescriptions.mode_b_b_fast' => 'Mode B+B的快速版本，為性能有限的裝置提供增強的線條修復和瑕疵處理。',
